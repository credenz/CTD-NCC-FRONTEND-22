    ...
    <Card className='ldiv bg-t'>
        ...
        <div className='qdisp bg-t b-2 br-2'>
            ...
            <Card className='qdispt bg-t c-w ' id="qdispt">
                ...
                <h4>Output Format:</h4>
                <textarea value={qdisp.output_format} className={"bg-t c-w disp-textarea"} readOnly></textarea>
                {/* <h5>{qdisp.output_format}</h5> */}
                <h4>Sample Input:</h4>
                <textarea value={qdisp.sample_input} className={"bg-t c-w disp-textarea"} readOnly></textarea>
